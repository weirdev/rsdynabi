...
pub fn run_rs_only_example_test() {
    {
        let adapter = {
            let arg = {
...
pub extern "C" fn extern_string_display_impl(arg: *mut core::ffi::c_void) -> ldyn::DynArg {
...
pub extern "C" fn extern_val1_cleanup_impl(arg: *mut core::ffi::c_void) {
    let arg = arg as *mut String;
